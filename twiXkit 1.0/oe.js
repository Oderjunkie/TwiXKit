...
document.querySelector('.invisible-in-contracted-header img').src = chrome.extension.getURL('edit.svg');
document.querySelector('.tweetdeck-logo').style.background = `url("${chrome.extension.getURL('edit.svg')}")`;
